...
<body>
    <div>
        <div class="row">
            ...
            <!-- <div class="col-lg-9 col-md-8 col-sm-7 col-xl-6 bg-danger"> -->
            ...
            <div class="col-lg-7 basic">
                ...
                @endif
                    <form class="row g-3 mt-2 p-2" method="post" action="{{ route('updateProfile') }}"
                    ...
                    @csrf
                        ...
                        <form class="d-flex hstack gap-2 me-5" role="loging">
                            ...
                            <button class="btn save m-2">Save</button>
                        </form>
