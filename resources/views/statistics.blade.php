                ...
                <div class="row d-flex ">
                  ...
                  <div class="row status">
                      ...
                      <div class="col-3 mt-5 ms-1 mb-0 p-0 d-flex Pendding ">
                          <img src="{{ asset('assets/images/pend.svg') }}" class="p-2 m-3 pnd" width="20%" height="60%">
                          <div class="m-1">
                              <p class="text-muted p-0 m-0">Pendding</p>
                              <p class="p-0" style="font-size: 30px;">5 <img src="{{ asset('assets/images/pend-arrow.png') }}" alt="">
                              </p>
